...
vdm = VDM(model=model,  image_shape=image_shape, gamma_min=-5.0, gamma_max=5)
...
#print("x bfore vocab size scaling: \n", x)
 #in the forward pass of the VDM we define the batch to contain x and labels so x is assigned to x and None is assigned to labels
